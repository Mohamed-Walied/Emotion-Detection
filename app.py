...
model = tf.keras.models.load_model(r"F:\AI and ML Diploma\Emotion Recognition Project\CNN_FER13_Model.keras")
...
def main():
    ...
    if choice == "Webcam":
        ...
        while choice == "Webcam":
            ...
            face_detector = cv2.CascadeClassifier(r"F:\AI and ML Diploma\Emotion Recognition Project\haarcascade_frontalface_default.xml")
